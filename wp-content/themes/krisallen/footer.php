			<footer class="footer" role="contentinfo">
				...
				<div id="inner-footer" class="wrap container clearfix">
					...
					<p class="pull-right">
						...
						<a href="http://twitter.com/krisallen" data-toggle="tooltip" title="Twitter" rel="tooltip" target="_blank"><i class="icon-twitter"></i></a>
						<a href="http://instagram.com/kris_allen" data-toggle="tooltip" title="instagram" rel="tooltip" target="_blank"><i class="icon-instagram"></i></a>
					</p>
